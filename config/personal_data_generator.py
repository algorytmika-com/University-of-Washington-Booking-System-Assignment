    ...
    [
        {
            ...
            "weight" : fake.pyfloat(positive=True, min_value=0, max_value=10),
            "volume" : fake.pyfloat(positive=True, min_value=0, max_value=125),
            ...
            "price_accepted" : fake.pyfloat(positive=True, min_value=25, max_value=200)
        }
        for _ in range(100)
    ]
)
