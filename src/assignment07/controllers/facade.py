...
def add_booking():
    while True:
        ...
        customer_booking = booking.Booking(booking_incremented_id, customer_name,
                                           destination_country, package_description,
                                           weight, volume, required_delivery_date,
                                           is_dangerous, is_urgent)
